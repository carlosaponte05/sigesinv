     ...
     <div class="col-lg-12">
      <div class="box box-info">
        <div class="box-header with-border" >
          <h3 class="box-title">
          Orden de Compra <strong>Código: {{$codigo}}</strong>
        ...
        <div class="box-body">
         <div class="row">
           <div class="col-lg-12">
            <form role="form" action="{{ route('admin.orden_compra.store') }}" class="form-horizontal" method="POST">

              {{ csrf_field() }}

              <div class="form-group{{ $errors->has('codigo') ? ' has-error' : '' }}">
                <label for="codigo" class="control-label col-sm-2">Proveedor:</label>
                <div class="col-sm-10">
              ...
              <hr>
              <div class="form-group{{ $errors->has('codigo') ? ' has-error' : '' }}">
                <label for="mensaje" class="control-label col-sm-6">Ingrese la cantidad a comprar por cada material</label>
              </div>
              <hr>
